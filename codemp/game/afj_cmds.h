...
#define PRIV_FRAGLIMIT		(0x0000000000000800u)
#define PRIV_GAMETYPE		(0x0000000000001000u)
#define PRIV_IGNORE			(0x0000000000002000u)
#define PRIV_IGNORELIST		(0x0000000000004000u)
#define PRIV_KICK			(0x0000000000008000u)
#define PRIV_KILL			(0x0000000000010000u)
#define PRIV_KNOCKMEDOWN	(0x0000000000020000u)
#define PRIV_LOGOUT			(0x0000000000040000u)
#define PRIV_MAP			(0x0000000000080000u)
#define PRIV_MAP_RESTART	(0x0000000000100000u)
#define PRIV_NOTCLIP		(0x0000000000200000u)
#define PRIV_NOTARGET		(0x0000000000400000u)
#define PRIV_NPC			(0x0000000000800000u)
#define PRIV_ORIGIN			(0x0000000001000000u)
#define PRIV_EMPOWER		(0x0000000002000000u)
